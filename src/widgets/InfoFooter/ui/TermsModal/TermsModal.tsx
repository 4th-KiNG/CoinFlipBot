...
interface TermsModalProps extends AppDialogProps {}

export const TermsModal: FC<TermsModalProps> = observer(({ open, onClose }) => {
  return (
    <Modal isOpen={open} className={classes.modalContainer} onClose={onClose}>
      <div className={classes.modalContent}>
        <Txt className={classes.title}>Terms and Conditions</Txt>
